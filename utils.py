...
import state
from config import log_channel_id, wolf_channel_id, seer_channel_id, witch_channel_id, voice_channel_id
...
async def init_channels(guild):
    ...
    if not all([state.log_channel, state.wolf_channel, state.seer_channel, state.witch_channel, state.voice_channel]):
